...
<body class="no-js">
    ...
    <div class="container page-header__container">
      ...
      <nav class="navigation">
        <ul class="main-menu main-menu--horisontal">
          ...
          <li class="main-menu__item">
            <a class="main-menu__link" href="#">Software</a>
          </li>
          <li class="main-menu__item">
            <a class="main-menu__link" href="#">Pricing</a>
          </li>
        </ul>
        <a class="button page-header__button" href="#">Get Started</a>
      </nav>
    </div>
  </header>
  ...
  <main class="page-content">
    <section class="promo">
      <div class="container">
        <h1 class="promo__title">What is Lorem Ipsum?</h1>
        <p class="promo__description">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
        <a class="button promo__button" href="#">Button</a>
      </div>
    </section>
    <section class="advantages">
      <h2 class="visually-hidden">Advantages</h2>
      <ul class="container advantages__list">
        <li class="advantages__item">Contrary to popular belief, Lorem <br>Ipsum is not simply random text</li>
        <li class="advantages__item">Lorem ipsum dolor sit amet, <br>consectetur adipiscing elit</li>
        <li class="advantages__item">The standard chunk of Lorem Ipsum <br>used since the 1500s is reproduced</li>
      </ul>
    </section>
  ...
  <footer class="page-footer">
    <div class="container page-footer__grid">
      <p class="page-footer__copyright">2021 All rights reserved</p>
      <ul class="footer-menu page-footer__menu">
        <li class="footer-menu__item">
          <a class="footer-menu__link" href="#">Privacy Policy</a>
        </li>
        <li class="footer-menu__item">
          <a class="footer-menu__link" href="#">Terms of Service</a>
        </li>
        <li class="footer-menu__item">
          <a class="footer-menu__link" href="#">Copyright Policy</a>
        </li>
      </ul>
    </div>
  </footer>
